...
## Crisis Resource 핫라인 (2026-04-26 업데이트)

위기 키워드 감지 시 다음 핫라인을 안내한다.
...
| **1577-9337** | 건강가정지원센터 | 시·군·구별 무료 가족 상담 |

### 표시 정책

- 즉각적 위기 키워드 감지 시: **즉각적 위기 핫라인** 우선 노출
- "이혼 절차", "이혼 변호사" 같은 행동 의도 키워드 감지 시: **법률·상담 안내** 노출
- "헤어지고 싶다" 같은 일반 감정 표현은 위기로 분류하지 않음 (화풀이 표현으로도 자주 사용)
