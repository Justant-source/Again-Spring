...
/**
 * Rolling-window rate limiter for PARSE_FAIL events in structured generation.
 *
...
public class ParseFailureRateLimiter {
    ...
    public boolean recordFailure(String correlationId, String errorMsg, String rawResponse) {
        ...
        return false;  // Parent logic (AiPostBundleService/LlmStatsRecorder) will call shouldAlertAndMarkSuppressed()
    }
