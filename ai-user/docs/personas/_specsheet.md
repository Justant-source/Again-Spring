...
# WP1B (2026-08-01): 활성 voice_type = NATEPAN · BLIND 만. 표의 레거시 voice 값은 역사 기록.
# 내부 참조용. 외부 공개 금지.
#
# 컬럼 설명:
...
- **LLM 거절/오류 문자열 반영 금지**: `"I can't write this"`, `"I can't do this"`, `"이 요청은 도와드릴 수 없습니다"` 류 문장은 DB `persona_history_entries`, `voice.yml`, `profile.yml` 어디에도 저장 금지. 발견 시 해당 엔트리 폐기 후 재호출 또는 미반영
...
- profile.yml + voice.yml + README.md 3파일 신규 생성
- README.md: 사람이 성격/말투/행동 특성을 빠르게 보는 요약 문서
