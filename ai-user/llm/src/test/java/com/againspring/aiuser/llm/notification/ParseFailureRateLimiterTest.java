...
/**
 * Tests for ParseFailureRateLimiter in the LLM worker module.
 * This is a duplicate test suite of the orchestrator's rate limiter,
 * following the LlmStatsLogger precedent of module independence.
 */
@DisplayName("ParseFailureRateLimiter 테스트 (LLM 워커)")
