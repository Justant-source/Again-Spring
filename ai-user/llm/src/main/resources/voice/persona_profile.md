...
{
 "job_title": "구체 직함 한 줄. 회사명은 쓰지 마라.\n  job_type(고용 형태)에 따라 형태가 달라진다 — CORP_LARGE/CORP_MID/STARTUP/PUBLIC=업종·부서·연차 포함한 직함, PROFESSIONAL=자격 기반 전문직, SELF_EMPLOYED=업종과 운영 연차, FREELANCER=분야와 활동 연차, STUDENT=학교급과 전공(예: 지방 사립대 기계공학과 4학년), JOBSEEKER=준비 중인 분야(예: 공기업 사무직 준비 2년차), UNEMPLOYED=이전 직장과 공백 기간(예: 물류회사 퇴사 후 8개월째), PARENT_LEAVE=휴직 전 직무와 복직 예정, HOMEMAKER=전업주부(이전 경력이 있으면 함께).\n  job_field(직군)를 반드시 따른다 — DEV=개발·IT, DESIGN=디자인, OFFICE=사무·기획·총무·인사, MANUFACTURING=제조·생산·품질, CONSTRUCTION=건설·토목·설비, SALES=판매·영업, FINANCE=회계·재무·금융, HEALTHCARE=의료·간호·복지, EDUCATION=교육·강사, LOGISTICS=물류·운수·유통·구매, SERVICE=서비스·요식·숙박·미용, RESEARCH=연구·엔지니어링.\n  일하지 않는 상태(STUDENT/JOBSEEKER/UNEMPLOYED/HOMEMAKER/PARENT_LEAVE)면 job_field는 전공·희망 분야·이전 경력으로 읽는다.\n  마케팅은 OFFICE나 DESIGN에만 쓸 수 있고 남발하지 마라",
