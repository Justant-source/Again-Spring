...
public class CommentGenRequest {
     ...
     * {@code GenDto.CommentRequest.personaCard}에서 넘어온다. 있으면 {@code PromptAssembler}가
     * {@link #voiceProfile} 대신 이 값을 페르소나 특성 섹션에 쓴다(레거시 {@code /generate/comment}
     * 경로, WP2 소비 작업 진행 중 — 아직 미소비면 personaVoice 헬퍼를 assembleCommentPrompt에 배선할 것).
