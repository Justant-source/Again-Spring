...
| POST | `/api/admin/marketing/x-ops/outbound` | **JWT + ADMIN** | 204 / 400 | 지금 선댓글 틱 1회(후보 조회+**최대 1건 게시**). 네이티브 영상(`hasVideo`)은 스킵 후 다음 후보. 선댓글 스위치 off면 400. Playwright가 길 수 있음. e2e에서 호출하지 않음 |
