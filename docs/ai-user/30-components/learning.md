...
- **(2026-09 persona-diversity-v4, WP1 병합 완료)** `persona_strengthener.py`의
  `update_persona_profiles()`는 신원 축뿐 아니라 문체 필드(`lexicon`·`writing_quirks`·
  `general_style`·`post_style`·`comment_style`·`reply_style`)까지 포함해 완전히 **no-op**으로
