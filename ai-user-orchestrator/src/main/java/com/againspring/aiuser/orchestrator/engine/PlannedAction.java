...
public record PlannedAction(
    ...
    public static PlannedAction like(PostDto post) {
        return new PlannedAction(ActionType.LIKE, post, null, null, null, null);
    }
    public static PlannedAction vote(PostDto post, Long optionId) {
        return new PlannedAction(ActionType.VOTE, post, optionId, null, null, null);
    }
    public static PlannedAction comment(PostDto post) {
        return new PlannedAction(ActionType.COMMENT, post, null, null, null, null);
    }
    public static PlannedAction reply(String postId, String postTitle, Long commentId, String excerpt, String ctx) {
        ...
        return new PlannedAction(ActionType.REPLY, stub, null, commentId, excerpt, ctx);
    }
    public static PlannedAction newPost() {
        return new PlannedAction(ActionType.POST, null, null, null, null, null);
    }
}
