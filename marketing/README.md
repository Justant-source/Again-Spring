# 마케팅 자동화 (Marketing) — dev 전용 (레거시)

다시봄 마케팅 자동화 관련 자원을 한곳에 모은 통합 디렉토리입니다. **모두 dev 환경 전용**이며 prod compose에는 포함되지 않습니다.

**2026-06-02 피벗 이후**: 커뮤니티 광장 모델로 전환으로 인해 이 모듈은 현재 미사용 상태입니다.
