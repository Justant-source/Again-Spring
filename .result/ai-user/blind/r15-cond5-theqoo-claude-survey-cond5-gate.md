# cond5 자동 게이트 — THEQOO r15-cond5-theqoo-claude-survey
> 생성: 2026-06-20T14:13:14.035873
...
| 지표 | 값 | 기준 | 결과 |
|---|---|---|---|
| estimated_human_detection_upper_bound | 0.690 | ≤ 0.60 | ❌ |
| proxy_accuracy | 0.150 | 참고값 | — |
| tell_top_score | 2 | ≤ 3 | ✅ |
| rep_pairs | 0 | == 0 | ✅ |
| topic_overlap | 0 | == 0 | ✅ |
| confused_frac | 0.200 | ≤ 0.15 | ❌ |
