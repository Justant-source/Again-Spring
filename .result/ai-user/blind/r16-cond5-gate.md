# cond5 자동 게이트 — THEQOO r16-ml-reranked-theqoo-survey-fixed
> 생성: 2026-06-20T19:32:10.120469
...
| 지표 | 값 | 기준 | 결과 |
|---|---|---|---|
| estimated_human_detection_upper_bound | 0.823 | ≤ 0.60 | ❌ |
| proxy_accuracy | 0.283 | 참고값 | — |
| tell_top_score | 0 | ≤ 3 | ✅ |
| rep_pairs | 0 | == 0 | ✅ |
| topic_overlap | 0 | == 0 | ✅ |
| confused_frac | 0.000 | ≤ 0.15 | ✅ |
