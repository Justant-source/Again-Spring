...
> - 사후 누적: E-008 60%·E-009 80%·E-010 40% 추가 → 최신 7인 평균 **37.1% ≤ 60%**, PASS 유지
...
> - ⚠️ 인과 주의: Phase5→8 출하 시점은 −60pp, 최신 7인 기준은 −42.9pp지만 둘 다 5변수 동시변화 → "Phase 6 기여" 시사·미증명. 게이트 PASS는 절대 임계라 유효
