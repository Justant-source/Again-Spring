...
**최종 갱신**: 2026-06-21 (v2.1 Phase 0·1·2·3·4 완료 ✅ · kill criterion 확정 ✅ — Phase 5 블라인드 키트 생성 대기)
...
| Phase | 핵심 | 선행 | 상태 |
|---|---|---|---|
| 5 | baseline 블라인드 (naive ≥3) | Phase 1·4 ✅ · kill criterion ✅ | 🔄 준비 중 |
| 6 | 결정론 다양화 1라운드 | Phase 5 | ⏳ 대기 |
| 7 | QLoRA 데이터게이트 | Phase 6 | ⏳ 대기 |
| 8 | 최종 판정·출하/피벗 | Phase 7 | ⏳ 대기 |

> **Phase 5 남은 조건**: naive ≥3 평가자 모집 (오너 제외). kill criterion은 확정 완료(2026-06-21).
